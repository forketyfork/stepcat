...
\`\`\``;
    ...
    describe('legacy "no issues" patterns', () => {
      it('should detect "no issues found" as PASS', () => {
        const output = 'The code review is complete. No issues found.';
      ...
      it('should detect "no issues detected" as PASS', () => {
        const output = 'No issues detected in the codebase.';
      ...
      it('should detect "no issues identified" as PASS', () => {
        const output = 'Review complete: no issues identified.';
      ...
      it('should detect "there are no issues" as PASS', () => {
        const output = 'After review, there are no issues.';
      ...
      it('should detect "there were no issues" as PASS', () => {
        const output = 'Checked everything, there were no issues.';
      ...
      it('should be case insensitive for legacy patterns', () => {
      ...
      it('should NOT match "no issues" when there are listed issues after', () => {
        const output = `While there are no critical issues, here are some concerns:
1. Missing tests in src/app.ts
2. Poor naming in src/util.ts`;
      ...
      it('should NOT match partial phrase like "looks good" alongside issues', () => {
        const output = `The structure looks good, but:
- src/main.ts has type errors
- src/test.ts needs refactoring`;
